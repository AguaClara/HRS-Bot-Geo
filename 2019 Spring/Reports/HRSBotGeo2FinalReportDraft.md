...
#### Data Collection and Analyzation in Excel and Python
...
optimal_parameters, covariance = opt.curve_fit(exp_func, elapsed_time, effluent_turbidity)

#reglineexp is the exponential line of regression
reglineexp = exp_func(elapsed_time, *optimal_parameters)

linreg = stats.linregress(elapsed_time, effluent_turbidity)
slope, intercept, r_value = linreg[0:3]

#reglinelin is the linear line of regression
reglinelin = elapsed_time*slope + intercept
...
plt.plot(elapsed_time,reglinelin)
plt.plot(elapsed_time,reglineexp)
plt.show()
```
...
linreg = stats.linregress(elasped_time, effluent_turbidity)
slope, intercept, r_value = linreg[0:3]
regline = elapsed_time*slope + intercept
...
plt.ylabel("Effluent Turbidity (NTU)")
plt.plot(elapsed_time, effluent_turbidity, "bo", markersize = 5)
plt.plot(elapsed_time, effluent_turbidity, "bo")
plt.plot(elapsed_time,regline)
plt.show()
```
